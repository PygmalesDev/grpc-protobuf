...
type LoginRequest struct {
	...
	AppId         int64                  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // ID of the app the user is trying to login to.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type LoginResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // Auth token for the logged in user.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type IsAdminRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        int64                  `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // ID of the user to check for admin status.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_sso_sso_proto_rawDesc = string([]byte{
	...
	0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x22,
	0x5a, 0x20, 0x70, 0x79, 0x67, 0x6d, 0x61, 0x6c, 0x65, 0x73, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x70,
	0x72, 0x6f, 0x6a, 0x2e, 0x76, 0x31, 0x3b, 0x67, 0x72, 0x70, 0x63, 0x72, 0x70, 0x6f, 0x6a, 0x5f,
